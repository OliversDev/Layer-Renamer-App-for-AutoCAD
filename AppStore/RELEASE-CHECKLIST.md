...
- Test prefix, suffix, find/replace, exact-name rename, exact and `*` wildcard filtering, persistent selection, manual script editing, copy, save, confirmation, and AutoCAD undo.
